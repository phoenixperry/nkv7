package
{
	...
	public class Diamonds extends Actor
	{
		...
		private function updateDiamond(e:Event):void
		{
			...
			//this has gotta be different for the diamond 
			//TODO create the diamond in a random position based on gravity in the world 
			// 
			//TODO increment the the speed this thing is moving 
			//if it's off screen, delete this object 
